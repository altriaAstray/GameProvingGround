    ...
    public class SQLiteLoder
    {
        ...
        public SQLiteLoder()
        {
            ...
            //if (!File.Exists(filepath))
            {
...
#if UNITY_ANDROID
                WWW loadDb = new WWW ("jar:file://" + Application.dataPath + "!/assets/" + DB_PATH); // this is the path to your StreamingAssets in android
                while (!loadDb.isDone) { } // CAREFUL here, for safety reasons you shouldn't let this while loop unattended, place a timer and error check
                // then save to Application.persistentDataPath
                File.WriteAllBytes (filepath, loadDb.bytes);
#elif UNITY_IOS
                string loadDb = Application.dataPath + "/Raw/" + DB_PATH; // this is the path to your StreamingAssets in iOS
                // then save to Application.persistentDataPath
                File.Copy (loadDb, filepath,true);
#elif UNITY_WP8
                string loadDb = Application.dataPath + "/StreamingAssets/" + DB_PATH; // this is the path to your StreamingAssets in iOS
                // then save to Application.persistentDataPath
                File.Copy (loadDb, filepath,true);
#elif UNITY_WINRT
                string loadDb = Application.dataPath + "/StreamingAssets/" + DB_PATH; // this is the path to your StreamingAssets in iOS
                ...
                string loadDb = Application.dataPath + "/Resources/Data/StreamingAssets/" + DB_PATH; // this is the path to your StreamingAssets in iOS
                // then save to Application.persistentDataPath
                File.Copy(loadDb, filepath,true);
#else
                string loadDb = Application.dataPath + "/StreamingAssets/" + DB_PATH; // this is the path to your StreamingAssets in iOS
